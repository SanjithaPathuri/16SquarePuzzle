...
def main():
    ...
    pygame.display.set_caption('15 Square Puzzle')
    BASICFONT = pygame.font.Font('freesansbold.ttf', BASICFONTSIZE)

    
    RESET_SURF, RESET_RECT = makeText('RESET',    TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 120)
    NEW_SURF,   NEW_RECT   = makeText('NEW GAME', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 80)
    SOLVE_SURF, SOLVE_RECT = makeText('SOLVE',    TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 120, WINDOWHEIGHT - 40)
...
def generateNewPuzzle(numSlides):
    ...
    for i in range(numSlides):
        ...
        slideAnimation(board, move, 'Generating new puzzle...', animationSpeed=int(TILESIZE / 8))
        makeMove(board, move)
